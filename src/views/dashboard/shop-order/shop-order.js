    ...
    methods: {
        ...
        async getOrerList() {
            try {
                ...
                let getOrerList = await Resful.post("cms-sale/OrderList/get_order_list", body)
                this.orderList = getOrerList.data.data.map(item => {
        ...
        async unAcceptOrder(orderID) {
            ...
            try {
                ...
                let unAcceptOrder = await Resful.post("cms-sale/OrderList/un_accept_order", body)
                console.log(unAcceptOrder)
        ...
        previous() {
            ...
            if(page > 1) {
                let id = this.shopID
                let pages = page - 1
                router.push({ path: 'shop-order', query: { id: id, page: pages} });
                this.getOrerList();
                location.reload();
                window.scrollTo(0,0);
            }
